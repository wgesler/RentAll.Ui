...
notifyOwnerShellContextChangedIfEmbedded(): void {
  ...
  buildPropertyFormOverrides(
    ...
    const overrides: Partial<PropertyRequest> = {
      ...
      accommodates: formValue['accommodates'] ? Number(formValue['accommodates']) : 0,
  ...
  buildCopiedPropertyInformationRequest(propertyId: string, organizationId: string): PropertyInformationRequest {
    ...
    return {
      ...
      departureInstructions: copied?.departureInstructions || undefined,
      departureCleaning: copied?.departureCleaning || undefined,
      departureMail: copied?.departureMail || undefined,
      departureFees: copied?.departureFees || undefined,
