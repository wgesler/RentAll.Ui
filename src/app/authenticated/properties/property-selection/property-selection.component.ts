...
export class PropertySelectionComponent implements OnInit, OnDestroy {
  ...
  buildForm(): void {
    this.form = this.fb.group({
      ...
      accommodates: new FormControl<number | null>(null),
      ...
      dogsOkay: new FormControl<boolean>(false),
      catsOkay: new FormControl<boolean>(false),
  ...
  patchFormFromResponse(response: PropertySelectionResponse | null): void {
    ...
    this.form.patchValue({
      ...
      accommodates: response?.accommodates ?? null,
      ...
      dogsOkay: response?.dogsOkay ?? false,
      catsOkay: response?.catsOkay ?? false,
  ...
  buildRequestFromForm(): PropertySelectionRequest | null {
    ...
    return {
      ...
      accommodates: this.toNumber(v.accommodates, 0),
