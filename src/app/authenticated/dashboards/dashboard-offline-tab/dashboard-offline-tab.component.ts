...
@Component({
  standalone: true,
  selector: 'app-dashboard-offline-tab',
  templateUrl: './dashboard-offline-tab.component.html',
  styleUrl: './dashboard-offline-tab.component.scss',
  imports: [MaterialModule, DataTableComponent],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DashboardOfflineTabComponent implements OnInit, OnDestroy {
  ...
  get checklistRows(): DashboardPropertyTurnoverRow[] {
    return this.snapshot.offlinePropertyRows;
  }

  get checklistColumns(): ColumnSet {
    return this.snapshot.propertyOfflineColumns;
  }

  get maintenanceRows(): MaintenanceListDisplay[] {
    return this.snapshot.goingOfflineMaintenanceDisplay;
  }

  get maintenanceColumns(): ColumnSet {
    return this.snapshot.goingOfflineMaintenanceColumns;
  }
