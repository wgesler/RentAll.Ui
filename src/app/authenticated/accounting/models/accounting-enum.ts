...
export const TransactionTypeLabels: { value: TransactionType, label: string }[] = [
  { value: TransactionType.ChargeProrate, label: 'Charge (Prorate)' },
  { value: TransactionType.ChargeOneTime, label: 'Charge (One-Time)' },
...
export function getTransactionType(transactionTypeId: number | undefined): string {
  ...
  const typeMap: { [key: number]: string } = {
    [TransactionType.ChargeProrate]: 'Charge (Prorate)',
    ...
    [TransactionType.ChargeOneTime]: 'Charge (One-Time)',
   };
...
export const JournalEntryKindLabels: { value: JournalEntryKind; label: string }[] = [
  ...
  { value: JournalEntryKind.SecurityDepositActual, label: 'Security Deposit Actual' },
  { value: JournalEntryKind.SecurityDepositWaiverActual, label: 'Security Deposit Waiver Actual' },
  { value: JournalEntryKind.FeesActual, label: 'Fees Actual' },
...
export function getJournalEntryKind(journalEntryKindId: number | undefined | null): string {
  ...
  const typeMap: { [key: number]: string } = {
    ...
    [JournalEntryKind.SecurityDepositActual]: 'Security Deposit Actual',
    [JournalEntryKind.SecurityDepositWaiverActual]: 'Security Deposit Waiver Actual',
    [JournalEntryKind.FeesActual]: 'Fees Actual',
