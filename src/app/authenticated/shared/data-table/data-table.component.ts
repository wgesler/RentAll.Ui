...
export class DataTableComponent implements OnChanges, OnInit {
  ...
  private setActions(): void {
    ...
    if (this.hasActionsCopy)     this.buttons.push({name: 'copy', callback: (event, rowItem) => this.emitCopyEvent(event, rowItem), color: '#5B8DB8', tooltip: 'Copy', tooltipPosition: 'before', icon: 'file_copy', suspendOnUpdate: false});
