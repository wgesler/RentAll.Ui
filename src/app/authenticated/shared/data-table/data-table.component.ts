...
export class DataTableComponent implements OnChanges, OnInit {
  ...
  setActions(): void {
    ...
    if (this.hasActionsCopy)     this.buttons.push({name: 'copy', callback: (event, rowItem) => this.emitCopyEvent(event, rowItem), color: '#2196F3', tooltip: 'Copy link', tooltipPosition: 'before', icon: 'link', suspendOnUpdate: false});
