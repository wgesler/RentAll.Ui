export enum RouterToken {
  ...
  ReceiptDraftList = 'receipt-drafts',
...
export enum RouterUrl {
  ...
  ReceiptDraftList          = `${RouterToken.Auth}/${RouterToken.ReceiptDraftList}`,
  ...
  Mobile                    = `${RouterToken.Mobile}`,
  MobileHome                = `${RouterToken.Mobile}/home`,
  MobileEmailCreate         = `${RouterToken.Mobile}/email/create`,
}
